// ─── features/profile/components/ClientProfilePage.tsx ────────────────────────
//
// Async RSC — own profile only, always authenticated.
//
// Usage:
//   <ClientProfilePage />
...
import {
    getMyClientProfileServer,
    getClientReviewsServer,
                            ...
                            {!profile.companyName &&
                                ...
                                !profile.companyDescription && (
                                    <div className="flex items-start gap-2 text-xs text-muted-foreground bg-muted/50 rounded-lg p-3">
                                        ...
                                        <p>
                                            Your company info helps freelancers understand who
                                            they&apos;d be working with. Add details in Settings.
                                        </p>
                                    </div>
                                )}
                        </CardContent>
