...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        // Matched to your Dialog overlay: bg-background/80 backdrop-blur-sm
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          "group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl",
          // Your panel style: bg-card border-border shadow-2xl
          "bg-card border border-border shadow-2xl",
          "p-4 text-foreground outline-none duration-200",
          "data-[size=default]:max-w-xs data-[size=default]:sm:max-w-sm data-[size=sm]:max-w-xs",
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-muted-foreground mt-0.5 text-balance md:text-pretty",
...
// ─── asChild on the primitive, Button as the rendered element (doc 3 pattern) ─
